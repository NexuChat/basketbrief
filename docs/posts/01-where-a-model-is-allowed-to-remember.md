...
- *Is this amount supported by this source?* → No. Code requires a stated total or currency-associated amount in the source text.
...
BasketBrief is open source under MIT: **github.com/NexuChat/basketbrief**. There is a live demo at **basketbrief.mlki.app** with a button that runs the whole journey against the real agent in about a minute. Every organisation, person and receipt in it is fictional and labelled as such.
