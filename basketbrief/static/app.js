...
async function playStory() {
  ...
  try {
    ...
    await apiAs('field', '/evidence', {method: 'POST', body: JSON.stringify({
      text: 'Correction: we recounted at the warehouse. 88 kits were delivered, not 92.', kind: 'message', question_id: null})});
    st = await untilIdle();
    await pause(2600);
